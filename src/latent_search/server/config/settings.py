...
# Custom test runner to ensure discovery works with nested structure
BASE_DIR_SRC = BASE_DIR.parent.parent
if str(BASE_DIR_SRC) not in sys.path:
    sys.path.insert(0, str(BASE_DIR_SRC))
...
ROOT_URLCONF = "latent_search.server.config.urls"
...
WSGI_APPLICATION = "latent_search.server.config.wsgi.application"
